...
<?php if(!in_array($usuario->getValue('_rol'),array_merge(\App\Entity\Usuario::getEjecutivosBE(),\App\Entity\Usuario::getAnalistasInternosBE(),[\App\Entity\Usuario::ROL_JEFATURA_BE]))): ?>
<style type="text/css">
	#modalNotas .fa-trash {
		display: none;
	}
...
<div class="row">
	<div class="col-md-12 col-sm-12 col-xs-12">
    	<div class="x_panel">
		    ...
		    <div class="x_content">
		        <form action="<?php echo e(route('be.miprospecto.lista.index')); ?>" class="form-horizontal">
		            <div class="row clearfix">
		                <div class="form-group col-md-5">
		                    <label for="" class="control-label col-md-3">DNI/RUC:</label>
		                    <div class="col-md-9">
		                        <input class="form-control formatInputNumber" type="text" value="<?php echo e($busqueda['documento']); ?>" name="documento">
		                    </div>
		                </div>
			            ...
			            <div class="row" id="filtros-avanzados" style="display: none;">
							<div class="form-group col-md-3">
			                    ...
			                    <div class="col-md-7">
				                    <select class="form-control" name="semaforo">
				                    	<option value="">Todos</option>
										<?php $__currentLoopData = \App\Entity\BE\Etapa::getSemaforos(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
	                            			<option value="<?php echo e($key); ?>" <?php echo e(($key == $busqueda['semaforo'])? 'selected="selected"':''); ?>
			                    ...
			                    <div class="col-md-9">
			                    	<select class="form-control" name="estrategia">
										...
										<?php $__currentLoopData = $estrategias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $estrategia): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
	                            			<option value="<?php echo e($estrategia->ID_CAMP_EST); ?>" <?php echo e(($estrategia->ID_CAMP_EST == $busqueda['estrategia'])? 'selected="selected"':''); ?>

	                            			><?php echo e($estrategia->NOMBRE); ?></option>
	                        			<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
	                        		</select>
			                    </div>
			                </div>
			                    ...
			                    <div class="col-md-9">
			                        <select class="form-control" name="etapa">
			                        	...
			                        	<?php $__currentLoopData = $etapas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $etapa): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
	                            			...
	                            			><?php echo e($etapa->NOMBRE); ?></option>
	                        			<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
									</select>
			                    </div>
			                </div>
			                <div class="form-group col-md-3">
			                    ...
			                    <div class="col-md-7">
			                        <select class="form-control" name="verificado">
			                        	<option value="">Todos</option>
				                    	<option value="1" <?php echo e((1 == $busqueda['verificado'])? 'selected="selected"':''); ?>>Sí</option>
										<option value="0" <?php echo e(('0' === $busqueda['verificado'])? 'selected="selected"':''); ?>>No</option>
									</select>
			                    </div>
			                </div>
			                    ...
			                    <div class="col-md-7 col-lg-8">
			                        <select class="form-control" type="text" name="bcoPrincipal">
										...
										<?php $__currentLoopData = $bancos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $banco): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
	                            			<option value="<?php echo e($banco->CODIGO); ?>" <?php echo e(($banco->CODIGO == $busqueda['bcoPrincipal'])? 'selected="selected"':''); ?>>
	                            			<?php echo e($banco->NOMBRE); ?></option>
	                        			<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
			                ...
			                <div class="form-group col-md-6 col-lg-4">
			                    ...
			                    <div class="col-md-8 col-lg-9">
			                        <div class="input-group">
	  									<input type="text" class="form-control formatInputNumber" value="<?php echo e($busqueda['minDeudaDirecta']); ?>" name="minDeudaDirecta">
	  									<span class="input-group-addon" >a</span>
	  									<input type="text" class="form-control formatInputNumber" value="<?php echo e($busqueda['maxDeudaDirecta']); ?>" name="maxDeudaDirecta">
									</div>
			                    </div>
			                </div>
			                <div class="form-group col-md-6 col-lg-4">
			                    ...
			                    <div class="col-md-9 col-lg-9">
			                    	<div class="input-group">
				                        <input type="text" class="form-control formatInputNumber" value="<?php echo e($busqueda['minDeudaIndirecta']); ?>" name="minDeudaIndirecta">
		  								<span class="input-group-addon" >a</span>
		  								<input type="text" class="form-control formatInputNumber" value="<?php echo e($busqueda['maxDeudaIndirecta']); ?>" name="maxDeudaIndirecta">
	  								</div>
			                    </div>
			                </div>
			                <div class="form-group col-md-6 col-lg-4">
			                    ...
			                    <div class="col-md-8 col-lg-9">
			                        <select class="form-control" type="text" name="bcoPrincipalGarantia">
			                        	<option>Todos</option>
			                        	<?php $__currentLoopData = $bancosGarantias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $banco): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
	                            			<option value="<?php echo e($banco->CODIGO); ?>" <?php echo e(($banco->CODIGO == $busqueda['bcoPrincipalGarantia'])? 'selected="selected"':''); ?>>
	                            			<?php echo e($banco->NOMBRE); ?></option>
	                        			<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
									</select>
			                    </div>
			                ...
			                <div class="form-group col-md-6 col-lg-4">
			                    ...
			                    <div class="col-md-9">
			                        <div class="input-group">
	  									<input type="text" class="form-control formatInputNumber" value="<?php echo e($busqueda['minGarantia']); ?>" name="minGarantia">
	  									<span class="input-group-addon" >a</span>
	  									<input type="text" class="form-control formatInputNumber" value="<?php echo e($busqueda['maxGarantia']); ?>" name="maxGarantia">
									</div>
			                    </div>
			                </div>
			            </div>
		...
		<div class="x_panel">
    		...
    		<div class="x_content">
		        ...
		        <table class="table table-striped jambo_table">
		            <thead>
		                <tr class="headings">
		                	<?php if(in_array($usuario->getValue('_rol'),\App\Entity\Usuario::getJefesGerentesBE())): ?>
		                	<th></th>
		                	<?php endif; ?>
		                    <th></th>
		                    <th style="width: 10%">Estrategia</th>
		                    <?php if(in_array($usuario->getValue('_rol'),array_merge(\App\Entity\Usuario::getDivisionBE(),\App\Entity\Usuario::getZonalesBE(),\App\Entity\Usuario::getJefaturasBE()))): ?>
		                    	<th style="width: 10%">Ejecutivo</th>
		                    <?php endif; ?>
		                    <th>Empresa</th>

		                    <th style="">
	                        <?php if(isset($orden) && $orden['sort'] == 'deudaD'): ?>
	                            <?php if(isset($orden) && $orden['order'] == 'asc'): ?>
	                                <a href="<?php echo e(route('be.miprospecto.lista.index', array_merge($busqueda,['sort' => 'deudaD','order' =>'desc']))); ?>">
	                                <i class="fa fa-sort-asc fa-lg order-icon-active"></i>
	                            <?php else: ?>
	                                <a href="<?php echo e(route('be.miprospecto.lista.index', $busqueda)); ?>">
	                                <i class="fa fa-sort-desc fa-lg order-icon-active"></i>
	                            <?php endif; ?>
	                        <?php else: ?>
	                            <a href="<?php echo e(route('be.miprospecto.lista.index', array_merge($busqueda,['sort' => 'deudaD','order' =>'asc']))); ?>">
		                    ...
		                    <th style="">
	                        <?php if(isset($orden) && $orden['sort'] == 'deudaI'): ?>
	                            <?php if(isset($orden) && $orden['order'] == 'asc'): ?>
	                                <a href="<?php echo e(route('be.miprospecto.lista.index', array_merge($busqueda,['sort' => 'deudaI','order' =>'desc']))); ?>">
	                                <i class="fa fa-sort-asc fa-lg order-icon-active"></i>
	                            <?php else: ?>
	                                <a href="<?php echo e(route('be.miprospecto.lista.index', $busqueda)); ?>">
	                                <i class="fa fa-sort-desc fa-lg order-icon-active"></i>
	                            <?php endif; ?>
			                <?php else: ?>
			                    <a href="<?php echo e(route('be.miprospecto.lista.index', array_merge($busqueda,['sort' => 'deudaI','order' =>'asc']))); ?>">
			                    <i class="fa fa-sort fa-lg order-icon"></i>
			                <?php endif; ?>
                        </a> 
		                    Deuda Indirecta</th>
		                    ...
		                    <th style="">
	                        <?php if(isset($orden) && $orden['sort'] == 'garantia'): ?>
	                            <?php if(isset($orden) && $orden['order'] == 'asc'): ?>
	                                <a href="<?php echo e(route('be.miprospecto.lista.index', array_merge($busqueda,['sort' => 'garantia','order' =>'desc']))); ?>">
	                                <i class="fa fa-sort-asc fa-lg order-icon-active"></i>
	                            <?php else: ?>
	                                <a href="<?php echo e(route('be.miprospecto.lista.index', $busqueda)); ?>">
	                                <i class="fa fa-sort-desc fa-lg order-icon-active"></i>
	                            <?php endif; ?>
	                        <?php else: ?>
	                            <a href="<?php echo e(route('be.miprospecto.lista.index', array_merge($busqueda,['sort' => 'garantia','order' =>'asc']))); ?>">
	                            <i class="fa fa-sort fa-lg order-icon"></i>
	                        <?php endif; ?>
                        </a> 
		                    Garantía</th>
		                    ...
		                    <th style="">
	                        <?php if(isset($orden) && $orden['sort'] == 'dias'): ?>
		                        <?php if(isset($orden) && $orden['order'] == 'asc'): ?>
		                            <a href="<?php echo e(route('be.miprospecto.lista.index', array_merge($busqueda,['sort' => 'dias','order' =>'desc']))); ?>">
		                            <i class="fa fa-sort-asc fa-lg order-icon-active"></i>
		                        <?php else: ?>
		                            <a href="<?php echo e(route('be.miprospecto.lista.index', $busqueda)); ?>">
		                            <i class="fa fa-sort-desc fa-lg order-icon-active"></i>
		                        <?php endif; ?>
		                    <?php else: ?>
		                        <a href="<?php echo e(route('be.miprospecto.lista.index', array_merge($busqueda,['sort' => 'dias','order' =>'asc']))); ?>">
		                        <i class="fa fa-sort fa-lg order-icon"></i>
		                    <?php endif; ?>
                        </a> 
		                    Días</th>
		            ...
		            <?php if(count($leads)>0): ?>
		                ...
		                <tr>
		                	...
		                	<td style="vertical-align: middle; text-align: center;">
	                            ...
	                            <input lead="<?php echo e($lead->NUM_DOC); ?>" type="checkbox" class='chkMantener' aria-label=""
		                	...
		                	<td style="vertical-align: middle; text-align: center;">
		                		...
		                		<?php if($color): ?>
		                			<i class="fa fa-circle fa-2x" aria-hidden="true" style="color: <?php echo e($color); ?>;"></i>
		                		<?php endif; ?>
		                	</td>
		                	<td style="vertical-align: middle;">
		                		<?php echo e($lead->ESTRATEGIA_NOMBRE); ?>

		                	</td>
		                	<?php if(in_array($usuario->getValue('_rol'),array_merge(\App\Entity\Usuario::getDivisionBE(),\App\Entity\Usuario::getZonalesBE(),\App\Entity\Usuario::getJefaturasBE()))): ?>
		                    	<td style="vertical-align: middle; width: 10%;">
		                    		<?php echo e($lead->EJECUTIVO_NOMBRE); ?>

		                    	</td>
		                    <?php endif; ?>
		                	<td style="vertical-align: middle;">
			                		<?php echo e($lead->NOMBRE); ?><br/>
			                		RUC: <?php echo e($lead->NUM_DOC); ?><br/>
			                		CU: <?php echo e($lead->COD_UNICO); ?>

		                	</td>
		                	<td style="vertical-align: middle;">
		                		S/. <?php echo e(number_format($lead->DEUDA_DIRECTA,0,'.',',')); ?>

		                	</td>
		                	<td style="vertical-align: middle;">
		                		<?php echo e($lead->BANCO_PRINCIPAL); ?>

		                	</td>
		                	<td style="vertical-align: middle;">
		                		S/. <?php echo e(number_format($lead->DEUDA_INDIRECTA,0,'.',',')); ?>

		                	</td>
		                	<td style="vertical-align: middle;">
		                		S/. <?php echo e(number_format($lead->GARANTIA,0,'.',',')); ?>

		                	</td>
		                	<td style="vertical-align: middle;">
		                		<!--<?php echo e($lead->BANCO_GARANTIA); ?>-->
		                		S/. <?php echo e(number_format($lead->DEUDA_TOTAL,0,'.',',')); ?>

		                	</td>
		                	<td style="vertical-align: middle;">
		                		<?php if($lead->ETAPA_EDITABLE == '1' && in_array($usuario->getValue('_rol'),\App\Entity\Usuario::getAnalistasEjecutivosBE())): ?>
		                			<a class="lnkEditEtapa" href="" etapa="<?php echo e($lead->ETAPA_ID); ?>" lead="<?php echo e($lead->NUM_DOC); ?>" style="text-decoration: underline;">
		                				<?php echo e($lead->ETAPA_NOMBRE); ?>
		                	...
		                	<td style="vertical-align: middle;" class="diasPendiente">
		                		<?php if($color): ?>
		                			<?php echo e($lead->DIAS_PENDIENTE); ?>d
		                		<?php endif; ?>
		                	</td>
		                	<td style="vertical-align: middle;">
		                		<a href="#" class="lnkNotas" lead="<?php echo e($lead->NUM_DOC); ?>" ejecutivo="<?php echo e($usuario->getValue('_registro')); ?>" style="text-decoration: underline;">Notas</a>
		                	</td>
		                	<td style="vertical-align: middle;">
		                		<a href="<?php echo e(route('be.actividades.index')); ?>?documento=<?php echo e($lead->NUM_DOC); ?>" style ="padding:8px;"> <i class="fa fa-bars fa-2x" data-toggle="tooltip" title="" data-placement="bottom"  aria-hidden="true"  data-original-title="Actividades" ></i></a>

		                		<a href="<?php echo e(route('be.micontacto.index')); ?>?documento=<?php echo e($lead->NUM_DOC); ?>" style ="padding:8px;"> 
		                			<?php if($lead->PRIORIDAD==1): ?>
		                				<img src = "<?php echo e(URL::asset('img/telefonoNuevo.png')); ?>" style="width: 40px;height: 40px">
		                			<?php else: ?>
		      					...
		      					<?php if(in_array($usuario->getValue('_rol'),\App\Entity\Usuario::getAnalistasEjecutivosBE())): ?>
		                		<a href="#" style ="padding:8px;" id ="btnEliminarLead"  documentoE="<?php echo e($lead->NUM_DOC); ?>"> <i class="fa fa-trash fa-2x btnEliminarLead" data-toggle="tooltip" title="" documentoE="<?php echo e($lead->NUM_DOC); ?>" data-placement="bottom"  aria-hidden="true"  data-original-title="Eliminar"></i></a>
		                		<?php endif; ?>
    	 ...
    	 <?php echo e($leads->appends(array_merge($busqueda,$orden))->links()); ?>
...
<div class="modal fade" tabindex="-1" role="dialog" id="modalEditarEtapa">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="frmEditarEtapa" class="form-horizontal form-label-left" action="<?php echo e(route('be.miprospecto.update-etapa')); ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                            <select class="form-control" name="etapa">
                                ...
                                <?php $__currentLoopData = $etapasHabilitadas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $etapa): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($etapa->ID_ETAPA); ?>" <?php echo e(($etapa->ID_ETAPA == $busqueda['etapa'])? 'selected="selected"':''); ?>>
                                    <?php echo e($etapa->NOMBRE); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="frmNuevoReferido" class="form-horizontal form-label-left" action="<?php echo e(route('be.miprospecto.registro-referido')); ?>" method="POST">					
                    <div class="col-lg-3">
                    ...
                    <div id="divLinkedin" class="hidden">
                        <div class="form-group col-md-12">
                      	<?php if($modoLinkedin): ?>
                        <img src = "<?php echo e(URL::asset('img/linkedin.png')); ?>" style="width: 3%; "/> <label for="exampleInputEmail1">¿Se empleó LinkedIn Sales Navigator para identificar al referido?</label>
...
<div class="modal fade" tabindex="-1" role="dialog" id="modalEliminarLead">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form method="POST" id="frmEliminarLead" class="form-horizontal form-label-left" action="<?php echo e(route('be.miprospecto.eliminar')); ?>">
                ...
                <div class="modal-body">
                    <div class="form-group">
						...
						<div class="col-md-12"><br>
                        	<img src = "<?php echo e(URL::asset('img/linkedin.png')); ?>" style="width: 3%; " /> <label for="exampleInputEmail1">¿Se encontró algún decisor en Linked In Sales Navigator?</label>
                ...
                <div class="modal-body">
					<?php $classForm = ''; 
						if (!in_array($usuario->getValue('_rol'),array_merge(\App\Entity\Usuario::getEjecutivosBE(),\App\Entity\Usuario::getAnalistasInternosBE(),[\App\Entity\Usuario::ROL_JEFATURA_BE])))
							$classForm = 'hidden'
					?>
                	<form method="POST" id="frmAgregarNota" class="form-horizontal form-label-left <?php echo e($classForm); ?>" action="<?php echo e(route('be.miprospecto.nota.agregar')); ?>">
                		<input type="hidden" name="lead" >
...
<script>
        ...
        .on('success.form.fv', function (e) {
            ...
            $.ajax({
                ...
                success: function (result) {
                    ...
                    link.closest('tr').find('.fa-circle').css('color',"<?php echo e(\App\Entity\BE\Etapa::COLOR_SEMAFORO_VERDE); ?>");
    ...
    function cargarNotas(ejecutivo,lead){
    	$.ajax({
                url: "<?php echo e(route('be.miprospecto.nota.listar')); ?>",
                type: 'GET',
                data: {
                	lead: lead,
                	ejecutivo: ejecutivo,
    ...
    function eliminarNota(e){    	
    	//var elem= e;
    	$.ajax({
                url: "<?php echo e(route('be.miprospecto.nota.eliminar')); ?>",
                type: 'POST',
                data: {
                	id: $(e).attr('idnota'),

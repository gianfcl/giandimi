                ...
                <div class="col-md-3 left_col menu_fixed">
                    <div class="left_col scroll-view" style="width: 100%">
                        <div class="navbar nav_title" style="border: 0; height: auto;">
                            <a href="#" class="site_title" style="margin-top: 20px;"><img src = "<?php echo e(URL::asset('img/paddy/paddy_logo_2.png')); ?>" style="width: 45%;margin-left: 20%;" /></a>
                        ...
                        <div id="sidebar_menu" class="main_menu_side hidden-print main_menu">
                            <div class="menu_section">
                                <ul class="nav side-menu">
                                    ...
                                    <li class="<?php echo e((Route::currentRouteName() == 'vista1')? 'active':''); ?>">
                                        <a href="<?php echo e(route('vista1')); ?>"><i class="fa fa-key"></i> Vista1</a>
                                    </li> 

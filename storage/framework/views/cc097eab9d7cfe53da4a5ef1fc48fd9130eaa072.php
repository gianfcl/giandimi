...
<?php $__env->startSection('pageTitle', 'Resumen Infinity'); ?>
...
<div class="row">
    <form action="<?php echo e(route('infinity.me.resumen')); ?>" class="form-horizontal">
                    ...
                    <div class="x_content" style="display: block;">
                        <center>
                            <div class="tile-stats">
                                <div class="count">+<?php echo e($movimientos['LINEAS_NUEVAS']); ?></div>
                                <h3 style="font-size: 20px">Nuevas líneas Infinity</h3>
                            </div>
                            <div class="tile-stats">
                                <div class="count"><?php if($movimientos['LINEAS_PERDIDAS']>0): ?>-<?php endif; ?><?php echo e($movimientos['LINEAS_PERDIDAS']); ?></div>
                            ...
                            <table class="tablaPersonalizada table-striped jambo_table">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="elementoTabla"><strong><?php echo e($migraciones->MIG_CLIENTE_1); ?></strong></td>                       
                                        <td class="elementoTabla"><strong><?php echo e(number_format($migraciones->MIG_SALDO_1/1000000,0,'.',',')); ?> M</strong></td>                      
                                    </tr>                                    
                                    <tr>
                                        <td class="elementoTabla">
                                        ...
                                        <td class="elementoTabla"><strong><?php echo e($migraciones->MIG_CLIENTE_2); ?></strong></td>                       
                                        <td class="elementoTabla"><strong><?php echo e(number_format($migraciones->MIG_SALDO_2/1000000,0,'.',',')); ?> M</strong></td>   
                                    </tr>
                                    <tr>
                                        <td class="elementoTabla">
                                            <i class="fa fa-circle fa-2x" style="color:#fc3"></i>
                                        ...
                                        <td class="elementoTabla"><strong><?php echo e($migraciones->MIG_CLIENTE_3); ?></strong></td>                       
                                        <td class="elementoTabla"><strong><?php echo e(number_format($migraciones->MIG_SALDO_3/1000000,0,'.',',')); ?> M</strong></td>   
                                    </tr>                                    
                                    <tr>
                                        <td class="elementoTabla">
                                            <i class="fa fa-circle fa-2x" style="color:#fc3"></i>
                                        ...
                                        <td class="elementoTabla"><strong><?php echo e($migraciones->MIG_CLIENTE_4); ?></strong></td>                       
                                        <td class="elementoTabla"><strong><?php echo e(number_format($migraciones->MIG_SALDO_4/1000000,0,'.',',')); ?> M</strong></td>   
                                    </tr>
                    ...
                    <div class="x_content" style="display: block;">
                        <div id="tablaCartera">
                            <table class="tablaPersonalizada table-striped jambo_table">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $composicionCartera; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $semaforo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td class="elementoTabla">
                                            <i class="fa fa-circle fa-2x" style="color:<?php echo e($semaforo['COLOR']); ?>"></i>
                                        </strong></td>                       
                                        <td class="elementoTabla"><strong><?php echo e($semaforo['CLIENTE_ACT']); ?></strong></td>                       
                                        <td class="elementoTabla">                                            
                                            <strong><?php echo e($semaforo['CLIENTE_ACT']-$semaforo['CLIENTE_ANT']); ?></strong>
                                            <?php if($semaforo['CLIENTE_ACT']>$semaforo['CLIENTE_ANT']): ?>
                                                    <i class="fa fa-arrow-circle-up" style="color:green"></i>
                                            <?php elseif($semaforo['CLIENTE_ACT']<$semaforo['CLIENTE_ANT']): ?>
                                                    <i class="fa fa-arrow-circle-down" style="color:red"></i>
                                            <?php else: ?>
                                                    <i class="fa fa-arrow-circle-up" style="color:green"></i>
                                            <?php endif; ?>
                                        </td>
                                        <td class="elementoTabla"><strong><?php echo e(number_format($semaforo['SALDO_ACT']/1000000,0,'.',',')); ?> M</strong></td>
                                        <td class="elementoTabla">
                                            <strong>
                                                <?php if($semaforo['SALDO_ANT']!=0): ?>
                                                    <?php echo e(number_format(($semaforo['SALDO_ACT']-$semaforo['SALDO_ANT'])*100/$semaforo['SALDO_ANT'],0,'.',',')); ?>%
                                                <?php else: ?>
                                                        0%
                                                <?php endif; ?>
                                            </strong>
                                            <?php if($semaforo['SALDO_ACT']>$semaforo['SALDO_ANT']): ?>
                                                    <i class="fa fa-arrow-circle-up" style="color:green"></i>
                                            <?php elseif($semaforo['SALDO_ACT']<$semaforo['SALDO_ANT']): ?>
                                                    <i class="fa fa-arrow-circle-down" style="color:red"></i>
                                            <?php else: ?>
                                                    <i class="fa fa-arrow-circle-up" style="color:green"></i>
                                            <?php endif; ?>

...
<script type="text/javascript" src="<?php echo e(URL::asset('js/jsContacto.js')); ?>"></script>
<?php $__env->stopSection(); ?>

<?php $__env->startSection('content'); ?>

<?php $__env->startSection('pageTitle', 'Mi Contacto'); ?>

<style type="text/css">
.twitter-typeahead, .tt-hint, .tt-input, .tt-menu { width: 100%; }
</style>
<input id="idContactoSeleccionado" type="hidden" value="<?php if(isset($idContacto)): ?> <?php echo e($idContacto); ?> <?php else: ?> <?php endif; ?>" name="">
<div class="row">
	<div class="col-md-12 col-sm-12 col-xs-12">
		<div class="x_panel">
			<div class="x_content">
				<form action="<?php echo e(route('be.micontacto.index')); ?>" class="form-horizontal" method="GET">
					<div class="row">
						<div class="form-group col-md-4">
							<label for="" class="control-label col-md-4">DNI/RUC:</label>
							<div class="col-md-8">
								<input class="form-control formatInputNumber" id="filtroDNIRUC" type="text" value="<?php echo e($busqueda['documento']); ?>" name="documento" maxlength="15">
							</div>
						</div>
						<div class="form-group col-md-4">
...
<div class="row">
	<div class="col-md-12 col-sm-12 col-xs-12">
		<div class="x_panel">
			<div class="x_content">
				<form action="<?php echo e(route('be.micontacto.update-datos')); ?>" method="POST" id="frmDatosCliente">
					<input name="numdoc" value="<?php echo e($lead->NUM_DOC); ?>" type="hidden">
                    
                    <?php if(!in_array($usuario->getValue('_rol'),\App\Entity\Usuario::getAnalistasEjecutivosBE(true))): ?>
                    <fieldset disabled>
                    <?php endif; ?>

					<div class="col-md-2 form-group">
						<h4><?php echo e($lead->NOMBRE); ?></h4>
						<span>RUC: <?php echo e($lead->NUM_DOC); ?></span><br/>
						<?php if($lead->COD_UNICO): ?>
                            <span>CU: <?php echo e($lead->COD_UNICO); ?></span><br/>
                        <?php endif; ?>
						<span>Categoría: <?php echo e($lead->CATEGORIA); ?></span>
					</div>
					<div class="col-md-2 form-group">
						...
						<select id="cboDepartamento" name="departamento" class="form-control">
							...
							<option value="<?php echo e($departamento->DEPARTAMENTO); ?>" <?php echo e(($departamento->DEPARTAMENTO == $lead->DEPARTAMENTO)? 'selected="selected"':''); ?>> <?php echo e($departamento->DEPARTAMENTO); ?>
					...
					<div class="col-md-2 form-group">
						...
						<select id="cboProvincia" name="provincia" class="form-control">
							...
							<option value="<?php echo e($provincia->PROVINCIA); ?>" <?php echo e(($provincia->PROVINCIA == $lead->PROVINCIA)? 'selected="selected"':''); ?>> <?php echo e($provincia->PROVINCIA); ?>
					...
					<div class="col-md-2 form-group">
						...
						<select id="cboDistrito" name="distrito" class="form-control">
							...
							<option value="<?php echo e($distrito->DISTRITO); ?>" <?php echo e(($distrito->DISTRITO == $lead->DISTRITO)? 'selected="selected"':''); ?>> <?php echo e($distrito->DISTRITO); ?>
					...
					<div class="col-md-2 form-group">
						...
						<input type="text" class="form-control" name="direccion" value="<?php echo e($lead->DIRECCION); ?>" maxlength="150">
					</div>
					<div class="col-md-2 form-group">
						<label for="">Teléfono</label> 
						<input type="text" class="form-control" name="telefono" value="<?php echo e($lead->TELEFONO); ?>" maxlength="9"> 
						<button type="submit" class="btn btn-success hidden" style="float: right; margin-top: 15px;" >Guardar</button>
                        <a class="btn btn-default hidden" style="float: right; margin-top: 15px;" href="<?php echo e(route('be.micontacto.index',['documento' => $lead->NUM_DOC])); ?>">Cancelar</a> 
					</div>
...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_content">
                <form action="<?php echo e(route('be.micontacto.update-datos')); ?>" method="POST" id="frmDatosCliente">
                    <input name="numdoc" value="<?php echo e($cliente->NUM_DOC); ?>" type="hidden">
                    ...
                    <div class="col-md-2 form-group">
                        ...
                        <span>RUC: <?php echo e($cliente->NUM_DOC); ?></span><br/>
                        <?php if($cliente->COD_UNICO): ?>
                            <span>CU: <?php echo e($cliente->COD_UNICO); ?></span><br/>
                        <?php endif; ?>
                        <span>Categoría: <?php echo e($cliente->CATEGORIA); ?></span>
                    </div>
                    <div class="col-md-2 form-group">
                        <label for="">Departamento</label>
                        <select id="cboDepartamento" name="departamento" class="form-control">
                            <option value="">---Todos----</option>
                            <?php $__currentLoopData = $departamentos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $departamento): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($departamento->DEPARTAMENTO); ?>" <?php echo e(($departamento->DEPARTAMENTO == $cliente->DEPARTAMENTO)? 'selected="selected"':''); ?>> <?php echo e($departamento->DEPARTAMENTO); ?>
                    ...
                    <div class="col-md-2 form-group">
                        ...
                        <select id="cboProvincia" name="provincia" class="form-control">
                            <option value="">---Todos----</option>
                            <?php $__currentLoopData = $provincias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $provincia): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($provincia->PROVINCIA); ?>" <?php echo e(($provincia->PROVINCIA == $cliente->PROVINCIA)? 'selected="selected"':''); ?>> <?php echo e($provincia->PROVINCIA); ?>
                    ...
                    <div class="col-md-2 form-group">
                        ...
                        <select id="cboDistrito" name="distrito" class="form-control">
                            <option value="">---Todos----</option>
                            <?php $__currentLoopData = $distritos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $distrito): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($distrito->DISTRITO); ?>" <?php echo e(($distrito->DISTRITO == $cliente->DISTRITO)? 'selected="selected"':''); ?>> <?php echo e($distrito->DISTRITO); ?>
                    ...
                    <div class="col-md-2 form-group">
                        <label for="">Dirección</label>
                        <input type="text" class="form-control" name="direccion" value="<?php echo e($cliente->DIRECCION); ?>" maxlength="150">
                    </div>
                    <div class="col-md-2 form-group">
                        <label for="">Teléfono</label> 
                        <input type="text" class="form-control" name="telefono" value="<?php echo e($cliente->TELEFONO); ?>" maxlength="9"> 
                        <button type="submit" class="btn btn-success hidden" style="float: right; margin-top: 15px;" >Guardar</button>
                        <a class="btn btn-default hidden" style="float: right; margin-top: 15px;" href="<?php echo e(route('be.micontacto.index',['documento' => $cliente->NUM_DOC])); ?>">Cancelar</a> 
                    </div>
...
<div class="row">
    <div class="col-md-3">
        <div id="panelListaContactos" class="x_panel">
            <ul class="nav nav-pills nav-stacked">
                ...
                <li class="<?php if(($contacto->ID_CONTACTO) == $idContacto): ?> active <?php else: ?>  <?php endif; ?>" idcontacto="<?php echo e($contacto->ID_CONTACTO); ?>"><a href="#"><?php echo e($contacto->NOMBRE); ?> <?php echo e($contacto->APELLIDO_PATERNO); ?>  <?php if($contacto->FLG_VIGENTE==2): ?><img src = "<?php echo e(URL::asset('img/ecosistema.png')); ?>" style="width: 20px;height: 20px;border-bottom-width: 10px;margin-bottom: 5px;margin-left: 5px;"><?php endif; ?>
                    <i class="fa fa-trash-o" data-toggle="tooltip" title="Eliminar" data-placement="bottom" style="float : right;" aria-hidden="true" onclick="cboQuitarContacto(<?php echo e($contacto->ID_CONTACTO); ?>,<?php echo e($busqueda['documento']); ?>)"></i></a> </li>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </ul>

            <?php if(in_array($usuario->getValue('_rol'),\App\Entity\Usuario::getAnalistasEjecutivosBE(true)) and $usuario->getValue('_rol')!=\App\Entity\Usuario::ROL_ANALISTA_EXTERNO_ZONAL_BE): ?>
    ...
    <div class="col-md-5">
        <div id="panelEditarContacto" class="x_panel hidden">
            ...
            <div class="x_content">
                <?php $__currentLoopData = $contactos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $contacto): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <form idcontacto="<?php echo e($contacto->ID_CONTACTO); ?>" class="hidden formEditarContacto" action="<?php echo e(route('be.micontacto.update-contacto')); ?>" method="POST">
                    
                    <?php if(!in_array($usuario->getValue('_rol'),\App\Entity\Usuario::getAnalistasEjecutivosBE(true)) or $usuario->getValue('_rol')==\App\Entity\Usuario::ROL_ANALISTA_EXTERNO_ZONAL_BE   ): ?>
                    <fieldset disabled>
                    <?php endif; ?>

                    <input type="hidden" name="idcontacto" value="<?php echo e($contacto->ID_CONTACTO); ?>">
                    <?php if($lead): ?>
                        <input type="hidden" name="numdoc"  value="<?php echo e($lead->NUM_DOC); ?>">
                    <?php else: ?>
                        <input type="hidden" name="numdoc"  value="<?php echo e($cliente->NUM_DOC); ?>">
                    <?php endif; ?>
                    <div class="row">
                        <div class="col-md-4">
                        ...
                        <div class="col-md-8">
                            <div class="form-group ">
                                ...
                                <input type="text" class="form-control"  id="numdoc" name="numdoccontacto" value="<?php echo e($contacto->NUM_DOC_CONTACTO); ?>">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label >Nombre</label>
                        <input type="text" class="form-control" name="nombre" id="nombres" value="<?php echo e($contacto->NOMBRE); ?>" maxlength="25">
                    </div>

                    <div class="form-group">
                        <label>Apellido Paterno</label>
                        <input type="text" class="form-control" name="apaterno" id="apaterno" value="<?php echo e($contacto->APELLIDO_PATERNO); ?>" maxlength="25">
                    </div>

                    <div class="form-group">
                        <label>Apellido Materno</label>
                        <input type="text" class="form-control" name="amaterno" value="<?php echo e($contacto->APELLIDO_MATERNO); ?>" maxlength="25">
                    </div>

                    <div class="form-group">
                        <label>Cargo</label>
                        <input type="text" class="form-control" name="cargo" value="<?php echo e($contacto->CARGO); ?>" maxlength="25">
                    </div>

                    <div class="form-group">
                        <label>Dirección</label>
                        <input type="text" class="form-control" name="direccion" value="<?php echo e($contacto->DIRECCION); ?>" maxlength="150">
                    </div>

                    <div class="form-group">
                        <label>Correo Electrónico</label>
                        <input type="text" class="form-control" name="email" value="<?php echo e($contacto->EMAIL); ?>" maxlength="50">
                    </div>

                    <?php if($lead): ?>
                    <a class="btn btn-default hidden" href="<?php echo e(route('be.micontacto.index',['documento' => $lead->NUM_DOC, 'idContacto' => $contacto->ID_CONTACTO])); ?>">Cancelar</a> 
                    <?php else: ?>
                    <a class="btn btn-default hidden" href="<?php echo e(route('be.micontacto.index',['documento' => $cliente->NUM_DOC, 'idContacto' => $contacto->ID_CONTACTO])); ?>">Cancelar</a> 
                    <?php endif; ?>
    ...
    <div class="col-md-4">
        <div id="panelInfoContacto" class="x_panel hidden">
            ...
            <div class="x_content">
                <table id="tblContactos" class="table table-condensed">
                    <tbody>
                        <?php $__currentLoopData = $addContactos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $addContacto): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="hidden" idContacto="<?php echo e($addContacto->ID_CONTACTO); ?>">
                            <td><label><?php echo e($addContacto->TIPO_CONTACTO); ?>:</label></td>
                            <td class="cellTelefono <?php echo ($addContacto->FEEDBACK == 'NEGATIVO') ? 'tachado' : '' ?>"><?php echo e($addContacto->VALOR); ?>

                                <?php if($addContacto->ANEXO): ?>
                                    - Anexo: <?php echo e($addContacto->ANEXO); ?>
                            ...
                            <td>
                                ...
                                <i feedback="POSITIVO"  lead="<?php echo e($addContacto->ID_CONTACTO); ?>"  valor="<?php echo e($addContacto->VALOR); ?>" aria-hidden="true"
                                    class="icon-feedback
                                ...
                                <i feedback="NEGATIVO"  lead="<?php echo e($addContacto->ID_CONTACTO); ?>"  valor="<?php echo e($addContacto->VALOR); ?>" aria-hidden="true"
                                    class="icon-feedback
                                ...
                                <?php else: ?>
                                    <?php if($addContacto->FEEDBACK == 'POSITIVO'): ?>
                                    ...
                                    <?php endif; ?>
                                    <?php if($addContacto->FEEDBACK == 'NEGATIVO'): ?>
        ...
        <div id="panelEncuestaContacto"" class="x_panel hidden">
            ...
            <div class="x_content">
                <?php $__currentLoopData = $contactos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $contacto): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="row hidden encuestaRow" idcontacto="<?php echo e($contacto->ID_CONTACTO); ?>">
                    <div class="row">
                        <div class="col-md-3">
                        ...
                        <div class="col-md-9">
                            <div class="btn-group  col-md-12" role="group" aria-label="...">
                                <button contacto="<?php echo e($contacto->ID_CONTACTO); ?>" type="button" class="btn col-md-4
                                ...
                                <div class="col-md-4" align="center">
                                    <input 
                                        <?php if(!in_array($usuario->getValue('_rol'),\App\Entity\Usuario::getAnalistasEjecutivosBE(true))): ?>
                                            readonly="readonly" 
                                        <?php endif; ?>
                                        type="checkbox" class="js-switch js-check-change " <?php echo (isset($contacto->TIPO_CONTACTO['Comercial']) && $contacto->TIPO_CONTACTO['Comercial'] == '1')? 'checked' : '' ?> tipo="Comercial" contacto="<?php echo e($contacto->ID_CONTACTO); ?>"/>
                                </div>
                                <div class="col-md-4" align="center">
                                    <input
                                        <?php if(!in_array($usuario->getValue('_rol'),\App\Entity\Usuario::getAnalistasEjecutivosBE(true))): ?>
                                            readonly="readonly" 
                                        <?php endif; ?>
                                        type="checkbox" class="js-switch js-check-change " <?php echo (isset($contacto->TIPO_CONTACTO['Crediticio']) && $contacto->TIPO_CONTACTO['Crediticio'] == '1')? 'checked' : '' ?> tipo="Crediticio" contacto="<?php echo e($contacto->ID_CONTACTO); ?>" />
                                </div>
                                <div class="col-md-4" align="center">
                                    <input
                                        <?php if(!in_array($usuario->getValue('_rol'),\App\Entity\Usuario::getAnalistasEjecutivosBE(true))): ?>
                                            readonly="readonly" 
                                        <?php endif; ?>
                                        type="checkbox" class="js-switch js-check-change " <?php echo (isset($contacto->TIPO_CONTACTO['Operativo']) && $contacto->TIPO_CONTACTO['Operativo'] == '1')? 'checked' : '' ?> tipo="Operativo" contacto="<?php echo e($contacto->ID_CONTACTO); ?>" />
                                </div>
                            </div>
                        </div>
                    </div>
...
<div class="modal fade" tabindex="-1" role="dialog" id="modalNuevoNumero">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="frmNuevoNumero" class="form-horizontal form-label-left" action="<?php echo e(route('be.micontacto.add-contacto-data')); ?>">
        ...
        <div class="modal-content">
            ...
            <form id="frmNuevoContacto" class="form-horizontal form-label-left" action="<?php echo e(route('be.micontacto.agregar-contacto')); ?>" method="POST">
                <div class="modal-body">
                    ...
                    <input type="hidden" name="lead">
                    <?php if($lead): ?>
                        <input name="numdoc" id="numdocAgregado" value="<?php echo e($lead->NUM_DOC); ?>" type="hidden">
                    <?php else: ?>
                        <input name="numdoc" id="numdocAgregado" value="<?php echo e($cliente->NUM_DOC); ?>" type="hidden">
                    <?php endif; ?>
...
<?php else: ?>
    <?php if((!$lead && $busqueda['documento']) || (!$cliente && $busqueda['documento'])): ?>

...
<link rel="stylesheet" href="<?php echo e(URL::asset('css/switchery.min.css')); ?>"  type="text/css" >
...
<?php $__env->startSection('pageTitle', 'Evaluación de Satisfacción'); ?>
...
<form id="frmEncuesta" class="form-horizontal form-label-left" action="<?php echo e(route('encuesta.guardar')); ?>" method="POST">
<div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
	<div class="x_panel" style="min-height: 533px">		
		...
		<label style="font-size: 16px">Preguntas: </label> <br>
			<?php if(count($preguntas)>0): ?>
				<?php $__currentLoopData = $preguntas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pregunta): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
					<?php if($pregunta->ID_PREGUNTA==0 or $pregunta->ID_PREGUNTA==4): ?>
							<?php continue; ?>	
					<?php else: ?>
							<p>P<?php echo e($pregunta->ID_PREGUNTA); ?>.- <?php echo e($pregunta->PREGUNTA); ?></p>		
					<?php endif; ?>
		...
		<center><br>
			...
			<?php endif; ?>
			<?php if($permisoResumen): ?>
			<a href="<?php echo e(route('encuesta.interna.resumen')); ?>">
...
<?php if(count($analistas)>0): ?>
		<?php $__currentLoopData = $analistas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $analista): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
		<div class="col-xs-12 col-sm-6 col-md-4 col-lg-3" >
			<div class="x_panel" style="min-height: 533px" >
				<div class="x_title" style="height: 200px">
					<h4 style="text-align: center;margin-bottom: 5px;"><?php echo e($analista->NOMBRE); ?></h4>
					<center>
						<label><?php echo e($analista->AREA); ?> </label><br>
				...
				<div class="x_content" style="display: block;">
							...
							<div class="pregunta0"> 
								<center>
										<label style="font-size: 12px">¿Has interactuado con <?php echo e($analista->PRIMER_NOMBRE); ?> en los últimos 3 meses?</label><br> <input type="checkbox" class="js-switch checkAnalista" name="checkAnalista[<?php echo e($analista->REGISTRO); ?>]" value="<?php echo e($analista->REGISTRO); ?>" <?php echo ($analista->FLG_RECONOCE==1 ? 'checked' : '');?>><br>
								</center>
							</div>
							<?php $__currentLoopData = $preguntas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pregunta): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								<?php if($pregunta->ID_PREGUNTA==0): ?>
										<?php continue; ?>
								<?php elseif($pregunta->ID_PREGUNTA==4): ?>
										<textarea class="form-control" rows="5" id="pregunta4" name="sugerencia[<?php echo e($analista->REGISTRO); ?>]" placeholder="<?php echo e($preguntas[4]->PREGUNTA); ?> <?php echo e($analista->PRIMER_NOMBRE); ?>?" disabled required><?php echo e($analista->SUGERENCIA); ?></textarea>			
								<?php else: ?>
									<?php 
									...
									<div class="conjuntoEstrellas" >
										...
										<div class="clasificacion" style="margin-bottom: 0px;" ><label style="margin-top: 10px;">P<?php echo e($pregunta->ID_PREGUNTA); ?>: &nbsp; </label>
									    <input disabled id="radio1<?php echo e($pregunta->ID_PREGUNTA); ?>-<?php echo e($analista->REGISTRO); ?>" type="radio" name="estrellas[<?php echo e($pregunta->ID_PREGUNTA); ?>-<?php echo e($analista->REGISTRO); ?>]" value="5" <?php echo ($estrellaPregunta==5 ? 'checked' : '');?>><!--
									    --><label class="estrellaX" for="radio1<?php echo e($pregunta->ID_PREGUNTA); ?>-<?php echo e($analista->REGISTRO); ?>"  style="font-size: 30px;">★</label><!--
									    --><input disabled id="radio2<?php echo e($pregunta->ID_PREGUNTA); ?>-<?php echo e($analista->REGISTRO); ?>" type="radio" name="estrellas[<?php echo e($pregunta->ID_PREGUNTA); ?>-<?php echo e($analista->REGISTRO); ?>]" value="4" <?php echo ($estrellaPregunta==4 ? 'checked' : '');?>><!--
									    --><label class="estrellaX" for="radio2<?php echo e($pregunta->ID_PREGUNTA); ?>-<?php echo e($analista->REGISTRO); ?>" style="font-size: 30px;">★</label><!--
									    --><input disabled id="radio3<?php echo e($pregunta->ID_PREGUNTA); ?>-<?php echo e($analista->REGISTRO); ?>" type="radio" name="estrellas[<?php echo e($pregunta->ID_PREGUNTA); ?>-<?php echo e($analista->REGISTRO); ?>]" value="3" <?php echo ($estrellaPregunta==3 ? 'checked' : '');?>><!--
									    --><label class="estrellaX" for="radio3<?php echo e($pregunta->ID_PREGUNTA); ?>-<?php echo e($analista->REGISTRO); ?>" style="font-size: 30px;">★</label><!--
									    --><input disabled id="radio4<?php echo e($pregunta->ID_PREGUNTA); ?>-<?php echo e($analista->REGISTRO); ?>" type="radio" name="estrellas[<?php echo e($pregunta->ID_PREGUNTA); ?>-<?php echo e($analista->REGISTRO); ?>]" value="2" <?php echo ($estrellaPregunta==2 ? 'checked' : '');?>><!--
									    --><label class="estrellaX" for="radio4<?php echo e($pregunta->ID_PREGUNTA); ?>-<?php echo e($analista->REGISTRO); ?>" style="font-size: 30px;">★</label><!--
									    --><input disabled id="radio5<?php echo e($pregunta->ID_PREGUNTA); ?>-<?php echo e($analista->REGISTRO); ?>" type="radio" name="estrellas[<?php echo e($pregunta->ID_PREGUNTA); ?>-<?php echo e($analista->REGISTRO); ?>]" value="1" required <?php echo ($estrellaPregunta==1 ? 'checked' : '');?>><!--
									    --><label class="estrellaX" for="radio5<?php echo e($pregunta->ID_PREGUNTA); ?>-<?php echo e($analista->REGISTRO); ?>" style="font-size: 30px;">★</label>
									  </div>			
									  </center>
									</div>							

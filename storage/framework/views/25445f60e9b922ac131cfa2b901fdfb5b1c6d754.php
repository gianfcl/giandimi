...
<?php $__env->startSection('pageTitle', 'Operaciones'); ?>
        ...
        <div class="x_content">
            <div class="filterbtnGroup" role="group" aria-label="g1">
                ...
                <div class="col-md-10 col-sm-10 col-xs-10 btn-group">   
                    <button type="button" style="width: 10%" class="btn btn-sm btn-secondary " data-toggle="button" autocomplete="on" onclick="window.location.href='<?php echo e(route('fies.operaciones.ejecutivo.operaciones.listar')); ?>?idEstacion=1'" >Pipeline<br/><span>   <?php echo e($resumen->PIPELINE); ?></span></button>
                    <button type="button" style="width: 10%" class="btn btn-sm btn-info " data-toggle="button" autocomplete="on" onclick="window.location.href='<?php echo e(route('fies.operaciones.ejecutivo.operaciones.listar')); ?>?idEstacion=2'">Cotizacion<br/><span><?php echo e($resumen->COTIZACION); ?></span></button>
                    <button type="button" style="width: 10%" class="btn btn-sm btn-info " data-toggle="button" autocomplete="on" onclick="window.location.href='<?php echo e(route('fies.operaciones.ejecutivo.operaciones.listar')); ?>?idEstacion=3'">FIES<br/><span><?php echo e($resumen->FIES); ?></span></button>
                    <button type="button" style="width: 10%" class="btn btn-sm btn-info " data-toggle="button" autocomplete="on" onclick="window.location.href='<?php echo e(route('fies.operaciones.ejecutivo.operaciones.listar')); ?>?idEstacion=4'">Riesgos<br/><span><?php echo e($resumen->RIESGOS); ?></span></button>
                    <button type="button" style="width: 10%" class="btn btn-sm btn-primary " data-toggle="button"  autocomplete="on" onclick="window.location.href='<?php echo e(route('fies.operaciones.ejecutivo.operaciones.listar')); ?>?idEstacion=5'">Aprobado<br/><span><?php echo e($resumen->APROBADO); ?></span></button> 



                    <button type="button" style="width: 20%" class="btn btn-sm btn-success " data-toggle="button" autocomplete="on" onclick="window.location.href='<?php echo e(route('fies.operaciones.ejecutivo.operaciones.listar')); ?>?idEstacion=6'">Desembolsado/Cobrado<br/><span><?php echo e($resumen->DESEMBOLSADO); ?></span></button>
                    <button type="button" style="width: 20%" class="btn btn-sm btn-default " data-toggle="button" autocomplete="on" onclick="window.location.href='<?php echo e(route('fies.operaciones.ejecutivo.operaciones.listar')); ?>?idEstacion=7'" >Terminado<br/><span><?php echo e($resumen->TERMINADO); ?></span></button>



                    <button type="button" style="width: 10%" class="btn btn-sm btn-secondary " data-toggle="button"  autocomplete="on" onclick="window.location.href='<?php echo e(route('fies.operaciones.ejecutivo.operaciones.listar')); ?>?idEstacion=8'">Perdida<br/><span><?php echo e($resumen->PERDIDA); ?></span></button>

                </div>
                <div class="col-md-1 col-sm-1 col-xs-1" align="center" >  
                    <ul class="nav navbar-right panel_toolbox">
                        <li  class="<?php echo e((Route::currentRouteName() == 'fies.operaciones.ejecutivo.operaciones.listar')? 'active':''); ?>"><a  class="collapse-link" href="<?php echo e(route('fies.operaciones.ejecutivo.operaciones.listar')); ?>"> Ver Todos</a></li>
                    </ul>
                </div>
            </div>
                ...
                <div class="form-group col-md-4 col-xs-12">
                    ...
                    <div class="col-md-8 col-xs-9">
                        <select id="cboGrupo_Zonal" name="grupo_zonal" class="form-control">
                            ...
                            <?php $__currentLoopData = $grupo_zonales; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $grupo_zonal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($grupo_zonal->GRUPO_ZONAL); ?>" <?php echo e(($grupo_zonal->GRUPO_ZONAL === $busqueda['grupo_zonal'])? 'selected="selected"':''); ?>>
                                <?php echo e($grupo_zonal->GRUPO_ZONAL); ?></option>
                    ...
                    <div class="form-group col-md-4 col-xs-12">
                        ...
                        <div class="col-md-8 col-xs-9">
                            <select id="cboMarca" name="ejeFies" class="form-control">
                                <option value="">---Todos----</option>
                                <?php $__currentLoopData = $ejecutivos_fies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ejecutivo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($ejecutivo->REGISTRO); ?>" <?php echo e(($busqueda['ejeFies'] == $ejecutivo->REGISTRO) ? 'selected="selected"' : ''); ?> ><?php echo e($ejecutivo->NOMBRE); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
        ...
        <table class="table table-striped jambo_table">
            <thead>
                <tr class="headings">
                    ...
                    <th></th>
                    <th style="width: 10%">
                        <?php if(isset($orden) && $orden['sort'] == 'ejeFies'): ?>
                        <?php if(isset($orden) && $orden['order'] == 'desc'): ?>
                        <a href="<?php echo e(route('fies.operaciones.ejecutivo.operaciones.listar', array_merge($busqueda,['sort' => 'ejeFies','order' =>'asc']))); ?>">
                            <i class="fa fa-sort-desc fa-lg order-icon-active"></i>
                            <?php else: ?>
                            <a href="<?php echo e(route('fies.operaciones.ejecutivo.operaciones.listar', $busqueda)); ?>">
                                <i class="fa fa-sort-asc fa-lg order-icon-active"></i>
                                <?php endif; ?>
                                <?php else: ?>
                                <a href="<?php echo e(route('fies.operaciones.ejecutivo.operaciones.listar', array_merge($busqueda,['sort' => 'ejeFies','order' =>'desc']))); ?>">
                            ...
                            <th style="width: 10%">
                                <?php if(isset($orden) && $orden['sort'] == 'estacion'): ?>
                                <?php if(isset($orden) && $orden['order'] == 'desc'): ?>
                                <a href="<?php echo e(route('fies.operaciones.ejecutivo.operaciones.listar', array_merge($busqueda,['sort' => 'estacion','order' =>'asc']))); ?>">
                                    <i class="fa fa-sort-desc fa-lg order-icon-active"></i>
                                    <?php else: ?>
                                    <a href="<?php echo e(route('fies.operaciones.ejecutivo.operaciones.listar', $busqueda)); ?>">
                                        <i class="fa fa-sort-asc fa-lg order-icon-active"></i>
                                        <?php endif; ?>
                                        <?php else: ?>
                                        <a href="<?php echo e(route('fies.operaciones.ejecutivo.operaciones.listar', array_merge($busqueda,['sort' => 'estacion','order' =>'desc']))); ?>">
                                            <i class="fa fa-sort fa-lg order-icon"></i>
                                            <?php endif; ?>
                                    ...
                                    <th style="width: 10%">
                                        <?php if(isset($orden) && $orden['sort'] == 'grupo_zonal'): ?>
                                        <?php if(isset($orden) && $orden['order'] == 'desc'): ?>
                                        <a href="<?php echo e(route('fies.operaciones.ejecutivo.operaciones.listar', array_merge($busqueda,['sort' => 'grupo_zonal','order' =>'asc']))); ?>">
                                            <i class="fa fa-sort-desc fa-lg order-icon-active"></i>
                                            <?php else: ?>
                                            <a href="<?php echo e(route('fies.operaciones.ejecutivo.operaciones.listar', $busqueda)); ?>">
                                                <i class="fa fa-sort-asc fa-lg order-icon-active"></i>
                                                <?php endif; ?>
                                                <?php else: ?>
                                                <a href="<?php echo e(route('fies.operaciones.ejecutivo.operaciones.listar', array_merge($busqueda,['sort' => 'grupo_zonal','order' =>'desc']))); ?>">
                                                    <i class="fa fa-sort fa-lg order-icon"></i>
                                                    <?php endif; ?>
                                                </a>Banca/Zona
                                            </th>
                                            <th style="width: 10%"> <?php if(isset($orden) && $orden['sort'] == 'nomCliente'): ?>
                                                <?php if(isset($orden) && $orden['order'] == 'desc'): ?>
                                                <a href="<?php echo e(route('fies.operaciones.ejecutivo.operaciones.listar', array_merge($busqueda,['sort' => 'nomCliente','order' =>'asc']))); ?>">
                                                    <i class="fa fa-sort-desc fa-lg order-icon-active"></i>
                                                    <?php else: ?>
                                                    <a href="<?php echo e(route('fies.operaciones.ejecutivo.operaciones.listar', $busqueda)); ?>">
                                                        <i class="fa fa-sort-asc fa-lg order-icon-active"></i>
                                                        <?php endif; ?>
                                                        <?php else: ?>
                                                        <a href="<?php echo e(route('fies.operaciones.ejecutivo.operaciones.listar', array_merge($busqueda,['sort' => 'nomCliente','order' =>'desc']))); ?>">
                                                            <i class="fa fa-sort fa-lg order-icon"></i>
                                                            <?php endif; ?>
                                                        </a>Razon Social
                                                    </th>
                                                    ...
                                                    <th style="width: 5%" > <?php if(isset($orden) && $orden['sort'] == 'mesDesem'): ?>
                                                        <?php if(isset($orden) && $orden['order'] == 'desc'): ?>
                                                        <a href="<?php echo e(route('fies.operaciones.ejecutivo.operaciones.listar', array_merge($busqueda,['sort' => 'mesDesem','order' =>'asc']))); ?>">
                                                            <i class="fa fa-sort-desc fa-lg order-icon-active"></i>
                                                            <?php else: ?>
                                                            <a href="<?php echo e(route('fies.operaciones.ejecutivo.operaciones.listar', $busqueda)); ?>">
                                                                <i class="fa fa-sort-asc fa-lg order-icon-active"></i>
                                                                <?php endif; ?>
                                                                <?php else: ?>
                                                                <a href="<?php echo e(route('fies.operaciones.ejecutivo.operaciones.listar', array_merge($busqueda,['sort' => 'mesDesem','order' =>'desc']))); ?>">
                                                                    <i class="fa fa-sort fa-lg order-icon"></i>
                                                                    <?php endif; ?>
                                                                </a>Mes Desemb</th>
                                                                <th style="width: 15%">Monto Comis.</th>
                                                                <th style="width: 5%"> <?php if(isset($orden) && $orden['sort'] == 'mesComi'): ?>
                                                                    <?php if(isset($orden) && $orden['order'] == 'desc'): ?>
                                                                    <a href="<?php echo e(route('fies.operaciones.ejecutivo.operaciones.listar', array_merge($busqueda,['sort' => 'mesComi','order' =>'asc']))); ?>">
                                                                        <i class="fa fa-sort-desc fa-lg order-icon-active"></i>
                                                                        <?php else: ?>
                                                                        <a href="<?php echo e(route('fies.operaciones.ejecutivo.operaciones.listar', $busqueda)); ?>">
                                                                            <i class="fa fa-sort-asc fa-lg order-icon-active"></i>
                                                                            <?php endif; ?>
                                                                            <?php else: ?>
                                                                            <a href="<?php echo e(route('fies.operaciones.ejecutivo.operaciones.listar', array_merge($busqueda,['sort' => 'mesComi','order' =>'desc']))); ?>">
                                                                                <i class="fa fa-sort fa-lg order-icon"></i>
                                                                                <?php endif; ?>
                                                                            </a>Mes Comision</th>                  
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td></td>
                                                                            <td>
                                                                                <?php echo e($operacion->NOMBRE); ?>

                                                                            </td>
                                                                            <td>
                                                                                <?php echo e($operacion->ULTIMO_ESTACION); ?>

                                                                            </td>
                                                                            <td>
                                                                                <?php echo e($operacion->GRUPO_ZONAL); ?><br/>
                                                                                <?php echo e($operacion->ENCARGADO); ?>

                                                                            </td>
                                                                            <td>
                                                                                RUC: <?php echo e($operacion->NUM_DOC); ?><br/>
                                                                                <?php echo e($operacion->NOMBRE_CLIENTE); ?>

                                                                            </td>
                                                                            <td>
                                                                                <?php echo e($operacion->PRODUCTO); ?>

                                                                            </td>
                                                                            <td>
                                                                                <?php echo e(number_format((int)$operacion->MONTO_PROBABLE_DESEMB,0,'.',',')); ?> <?php echo e($operacion->MONEDA_DESEMB); ?>

                                                                            </td>
                                                                            <td>
                                                                                <?php echo e($operacion->MES_PROBABLE_DESEMB); ?>

                                                                            </td>
                                                                            <td>
                                                                                <?php echo e(number_format((int)$operacion->MONTO_PROBABLE_COM,0,'.',',')); ?>  <?php echo e($operacion->MONEDA_COM); ?>

                                                                            </td>
                                                                            <td>
                                                                                <?php echo e($operacion->MES_PROBABLE_COM); ?>

                                                                            </td>
                                                                            <td>
                                                                                <?php echo e($operacion->PROBABILIDAD); ?>

                                                                            </td>

                                                                            <td style="vertical-align: middle; text-align: center;">

                                                                                <a href="<?php echo e(route('fies.operaciones.ejecutivo.operaciones.detalle')); ?>?codOperacion=<?php echo e($operacion->COD_OPERACION); ?>" class="btn btn-info btn-lg">
                                                            ...
                                                            <?php echo e($operaciones->appends($busqueda)->links()); ?>
                                        ...
                                        <div class="modal fade" tabindex="-1" role="dialog" id="modalNuevaOperacion">
                                            <div class="modal-dialog" role="document"  style="width: 40%;">
                                                <div class="modal-content">
                                                    ...
                                                    <form id="formNuevaOperacion" method="POST" class="form-horizontal form-label-left"  action="<?php echo e(route('fies.operaciones.ejecutivo.operaciones.registrar-operacion')); ?>"  >
                                                    ...
                                                    <div  class="form-group">
                                                      ...
                                                      <input type="hidden" name="page" value="<?php echo e(Auth::user()->ROL); ?>" >
                                                      <?php if( Auth::user()->ROL =="11" ): ?>

                                                      <div class="col-md-3 col-sm-9 col-xs-12">
                                                        <input  name="ejecutivoFies" onkeypress="return validaLetras(event)" class="form-control"  readonly="readonly" value="<?php echo e(Auth::user()->REGISTRO); ?>" >                               
                                                    </div>
                                                    <div class="col-md-6 col-sm-9 col-xs-12">
                                                        <input name="ejeFiesNom" onkeypress="return validaLetras(event)" class="form-control" readonly="readonly" value="<?php echo e(Auth::user()->NOMBRE); ?>" > 
                                                    </div>
                                                    <?php else: ?> 
                                                    <div class="col-md-6 col-sm-9 col-xs-12">
                            ...
                            <input type="hidden" name="page" value="<?php echo e($busqueda['page']); ?>">
                            <input type="hidden" name="documento" value="<?php echo e($busqueda['documento']); ?>">
                            <input type="hidden" name="grupo_zonal" value="<?php echo e($busqueda['grupo_zonal']); ?>">
                            <input type="hidden" name="estacion" value="<?php echo e($busqueda['estacion']); ?>">

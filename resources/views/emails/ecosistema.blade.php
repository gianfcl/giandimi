...
<body paddingwidth="0" paddingheight="0" bgcolor="#d1d3d4"  style="padding-top: 0; padding-bottom: 0; padding-top: 0; padding-bottom: 0; background-repeat: repeat; width: 100% !important; -webkit-text-size-adjust: 100%; -ms-text-size-adjust: 100%; -webkit-font-smoothing: antialiased;" offset="0" toppadding="0" leftpadding="0">
  ...
  <tbody>
    ...
    <tr><center>
      <img src="http://b29310t16w7:8080/prod/public/img/vpconnect.png" alt="Logo" title="Logo" style="width:400px"></td>
    </center></tr>
                        ...
                        <td>
                          <div class='contentEditableContainer contentTextEditable'>
                            <div class='contentEditable' style='text-align: center;'>
                              <h2 style="font-size: 20px;">¡Felicidades {{$nombresCompletos}}!</h2>
                              <br>
                              <p>Acabas de recibir un nuevo prospecto identificado desde un ecosistema compartido con Gabriella Bassino.</p>
                            </div>
                          </div>
                        </td>
                      </tr>
      ...
      <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                      ...
                      <tr>
                        <td>
                          <div class='contentEditableContainer contentTextEditable'>
                            <div class='contentEditable' style='text-align: center;'>
                              <h2 style="font-size: 20px;">Detalles</h2>
                              <br>
                              <p>El nombre del prospecto es xxxxxxxxx y es CLIENTE de la empresa xxxxxxxxxxxxx. El dato de contacto del prospecto es xxxxxxxxxxxx y su teléfono es xxxxxxxxxxxx . Comunícate con ella de parte de xxxxxxx.
                              </p>
                              <br><br>
                              <a target='_blank' href="http://b29310t16w7:8080/prod/public/" class='link2' style='color:#ffffff;'>Ingresar a la VPCONNECT</a>
                              <br>
                            </div>
                          </div>
                        </td>
                        ...
                        <td>
                          <div class='contentEditableContainer contentTextEditable'>
                            <div class='contentEditable' style='text-align: center;color:#AAAAAA;'>
                              <p>
                              Enviado por RubriK PUCP <br/>
                              rubrik.pucp@gmail.com <br/>
                              </p>
                            </div>
                          </div>
                        </td>
                      ...
                      <tr>
                        <td width='40'>
                          <div class='contentEditableContainer contentFacebookEditable'>
                            <div class='contentEditable' style='text-align: center;color:#AAAAAA;'>
							<i class="fa fa-users" style="font-size:30px;color: #005b7f"></i>
                            </div>
                          </div>
                        </td>
                        <td width='10'></td>
                        <td width='40'>
                          <div class='contentEditableContainer contentTwitterEditable'>
                            <div class='contentEditable' style='text-align: center;color:#AAAAAA;'>
							<i class="fa fa-bar-chart-o" style="font-size:30px;color: #005b7f"></i>
                            </div>
                          </div>
                        </td>
                        <td width='10'></td>
                        <td width='40'>
                          <div class='contentEditableContainer contentImageEditable'>
                            <div class='contentEditable' style='text-align: center;color:#AAAAAA;'>
                              <i class="fa fa-mortar-board" style="font-size:30px;color: #005b7f"></i>
                            </div>
                          </div>
                        </td>
                        <td width='10'></td>
                        <td width='40'>
                          <div class='contentEditableContainer contentImageEditable'>
                            <div class='contentEditable' style='text-align: center;color:#AAAAAA;'>
                              <i class="fa fa-list-ul" style="font-size:30px;color: #005b7f"></i>
                            </div>
                          </div>
                        </td>
                      </tr>

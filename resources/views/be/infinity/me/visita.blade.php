...
@section('pageTitle','Ficha Visita')
...
<form id="frmVisita" action="{{route('infinity.me.cliente.visita.guardar')}}" method="POST">
    ...
    <input type="hidden" name="flgPorRevisar" value="{{$flgPorRevisar && $usuario->getValue('_rol') != App\Entity\Usuario::ROL_JEFATURA_BE}}" />

    @if ($flgPorRevisar)
    <div class="alert alert-warning" role="alert">La visita está pendiente de revisión.</div>
    @endif

    @if (!$flgPorRevisar && $usuario->getValue('_rol') == App\Entity\Usuario::ROL_JEFATURA_BE)
            ...
            <div class="x_panel">
                <div class="x_content">
                    <div class="col-md-6 col-sm-12 col-xs-12">
                        ...
                        <div class="checkbox">
                            <label class="formatoCheck">
                                <input name="flagCambioConcentracionProveedores" id="flagCambioConcentracionProveedores" type="checkbox" {{$visita->getValue('_flagCambioConcentracionProveedores')== 1?'checked':''}}>¿Cambió la concentración de proveedores de sus clientes?
                            </label>
                        </div>
            ...
            <div class="x_panel">
                ...
                <div class="x_content" style="min-height: 150px" > 
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-4"> 
                            <select class="form-control inputMixVentas" name="mixVenta[{{$i}}][participacion]">
            ...
            <div class="x_panel">
                ...
                <div class="x_content">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-2"> 
                            <input class="form-control inputConcentProv" type="text" name="proveedor[{{$i}}][nombre]" maxlength="50" value="{{isset($cliente->getValue('_proveedores')[$i])?$cliente->getValue('_proveedores')[$i]->getValue('_nombre'):''}}" disabled>
                        </div>
                        <div class="form-group col-sm-2"> 
            ...
            <div class="x_panel">
                ...
                <div class="x_content" style="min-height: 150px">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-2"> 
                            <input class="form-control inputConcentCli" type="text" name="cliente[{{$i}}][nombre]" maxlength="50" disabled="disabled" value="{{isset($cliente->getValue('_clientes')[$i])?$cliente->getValue('_clientes')[$i]->getValue('_nombre'):''}}">
                        </div>
                        <div class="form-group col-sm-2"> 
                ...
                <div class="x_content form-horizontal">
                    <div class="grupoCheck">
                        <div class="checkbox col-md-12"  style="padding-bottom: 10px">
                            ...
                            <div class="col-md-4 col-sm-6">
                                <input type="text" class="form-control"  name="cambioGerenciaGeneralAnnio" placeholder="año" value="{{$cliente->getValue('_cambioGerenciaGeneralAnnio')}}" disabled>
                            </div>
                        </div>
                        <div class="form-group">
                    ...
                    <div class="grupoCheck">
                        <div class="checkbox col-md-12"  style="padding-bottom: 10px">
                            ...
                            <div class="col-md-4 col-sm-6">
                                <input type="text" class="form-control"  name="cambioAccionistasAnnio" value="{{$cliente->getValue('_cambioAccionistasAnnio')}}" disabled>
                            </div>
                        </div> 
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-sm-2"> 
                                <input class="form-control" type="text" name="accionista[{{$i}}][nacimiento]" maxlength="4" value="{{isset($cliente->getValue('_accionistas')[$i])?$cliente->getValue('_accionistas')[$i]->getValue('_nacimiento'):''}}" disabled>
                            </div>
                        </div>
                        @endfor
                    </div>
            ...
            <div class="x_panel">
                ...
                <div class="x_content form-horizontal">
                    <div class="form-group">
                        ...
                        <div class="col-sm-3 col-xs-12">
                            <input type="text" class="form-control" value="{{$cliente->getValue('_montoLineaProveedores')}}" name="montoLineaProveedores">
                        </div>
                    </div>
                ...
                <div class="x_content">
                    <div class="form-group col-sm-12" >
                        ...
                        <div class="col-md-4 col-sm-4">
                            <input type="text" class="form-control" id="inputProyeccionInversion" name="proyeccionInversion" value="{{$cliente->getValue('_proyeccionInversion')}}">
                        </div>
                    ...
                    <div class="form-group col-sm-12">
                        ...
                        <div class="col-md-4 col-sm-4">
                            <input type="text" class="form-control" name="proyeccionVentas" value="{{$cliente->getValue('_proyeccionVentas')}}">
                        </div>
                ...
                <div class="x_content form-horizontal">
                    ...
                    <div class="col-md-6 col-xs-12 col-sm-12"> 
                        <div class="form-group">
                            ...
                            <div class="col-sm-6 col-xs-12">
                                <input type="text" class="form-control" readonly value="{{$usuario->getValue('_rol') == App\Entity\Usuario::ROL_JEFATURA_BE? $visita->getValue('_registroNombre'):$usuario->getValue('_nombre')}}" >
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6 col-xs-12">
                                <input type="text" name="nombreVisita" class="form-control" value='{{$visita->getValue('_entrevistadoNombre')}}'>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12 col-xs-12 col-sm-12"> 
                        <div class="form-group">
                            ...
                            <div class="input-group col-md-8 col-sm-8 col-xs-12">
                                <textarea class="form-control" rows="10" style="resize: none" placeholder="Ingresar Comentario..." name="comentarioVisita" >{{$visita->getValue('_comentarios')}}</textarea>
                            </div>
                        </div>
                    </div>

            ...
            <div class="x_content">
                <form class="form-horizontal form-label-left input_mask">
                    <div class="form-group">
                        ...
                        <a href="{{route('infinity.me.cliente.conoceme')}}?cu={{$cliente->COD_UNICO}}" style="text-decoration: underline;font-weight: bold">Conóceme</a>
                    </div>
                    <div class="form-group">
            ...
            <div class="x_content">
                <form class="form-horizontal form-label-left input_mask">
                    ...
                    <div class="form-group" style="padding-bottom: 15px">
                        ...
                        <a href="{{route('infinity.me.cliente.visita')}}?cu={{$cliente->COD_UNICO}}" style="text-decoration: underline;font-weight: bold">Agregar Visita</a>
                    </div>
                    <div class="form-group" style="padding-bottom: 15px">
    ...
    <div class="col-sm-6 col-xs-12">
        <div class="x_panel" style="min-height: 800px">
            ...
            <div class="x_content">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-md-9 col-sm-9 col-xs-12">
                                <select class="form-control" name="cboMesExplicacion" id="cboMesExplicacion">
                                    ...
                                    <option value="{{$mes['PERIODO']}}">{{$mes['MES']}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                ...
                <div class="row">  
                    <div class="col-md-12">
                        <table class="table table-striped table-bordered jambo_table" id="tableExplicaciones">
                            <thead>
                                <tr>
                                    <th style="width: 70%">Condición</th>
                                    <th style="width: 30%">Valor</th>
                                </tr>
                            </thead>
                            <tbody>
                                @foreach ($explicaciones as $explicacion)
                                <tr class="tr-explicacion-{{$explicacion->PERIODO}} {{$explicacion->PERIODO == 201810? '':'hidden'}}">
                                    <td>{{$explicacion->CONDICION_ALERTA}}</td>
                                    <td>{{$explicacion->VALOR_VARIABLE}}</td>
                                </tr>
                                @endforeach
                            </tbody>
                        </table>
                    ...
                    <div class="col-md-12">
                        <table class="table table-striped jambo_table tableHistorico" id="tablePoliticas">
                            ...
                            <tbody>
                                ...
                                <tr class="tr-{{$politica->PERIODO}} {{$politica->PERIODO == config('app.periodoInfinity')? '':'hidden'}}">
                                    <td>{{$politica->TIPO}}</td>
                    ...
                    <div class="col-md-12"  style="padding-left: 20px" style="width: 70%">
                        <table id="tableSalidas" class="table table-striped jambo_table tableHistorico">
                            ...
                            <tbody>
                                ...
                                <tr class="tr-{{$salida->PERIODO}} {{$salida->PERIODO == 201810? '':'hidden'}}">
                                    <td style="font-size:14px ;text-decoration: underline;">{{$salida->MOTIVO_SALIDA}}</td>
                                </tr>
                                @endforeach
                                @else
            ...
            <div class="x_content" style="max-height: 380px; <?php echo (count($gestiones) > 0 ? 'overflow-y: scroll' : ''); ?>;">
                ...
                <table class="table table-striped table-bordered jambo_table">
                    ...
                    <tbody>
                        ...
                        <tr style="">
                            <td style="width: 10%;padding-bottom: 30px">{{$gestion->NOMBRE}}<br>{{$gestion->CARGO}}</td>
                            <td style="width: 5%;padding-bottom: 30px">{{$gestion->FECHA_GESTION}}</td> 
                ...
                <div class="col-sm-12">
                        @if(count($grupoEconomico['RELACIONADOS'])>0)
                            ...
                            <div class="col-sm-12" style="padding-bottom:20px">
                                <label style="text-decoration: underline;">{{$relacionado->NOMBRE_REL}}</label><br>
                                <div class="col-sm-4 col-xs-12">
                                    <?php
